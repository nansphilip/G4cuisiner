...
import { ResetLink, ResetPassword } from "@actions/auth/reset";
...
export default function ResetClient({
    ...
    return (
        <CsrfFormClient onSubmit={(e) => reset(e)} className={className}>
            {children}
            {/* {token ? (
                <>
                ...
                <>
                    <p className="text-center text-xs text-gray-500">
                        Provide your email to reset password. You will receive a password reset link.
                    </p>
                    <label className="flex w-full flex-col gap-1">
                        Email
                        <input
            ...
            <h2 className="text-center text-sm italic text-gray-600">
